...
`specs/ARCHIVE/remaining-issues-2026-04-30.md` preserves the historical
repository-local closeout for earlier follow-up items; current readiness posture
lives in `specs/CURRENT/research-platform-readiness-and-scope-2026-05-21.md`. A row marked resolved there does **not** imply the
